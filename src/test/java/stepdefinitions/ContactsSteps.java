...
public class ContactsSteps {
	...
	public void user2_has_already_login_to_application(DataTable dataTable) {
	...
	@Then("title4 of page should be {string}.")
	public void title4_of_page_should_be(String string) {
